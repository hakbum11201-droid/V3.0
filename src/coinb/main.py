...
def main() -> None:
    ...
    elif args.command == "net-edge-candidate-diagnostics":
        from .net_edge_candidate_diagnostics import run_net_edge_candidate_diagnostics
        
        result = run_net_edge_candidate_diagnostics(
            opportunity_path=args.opportunity,
            backtest_path=args.backtest,
    ...
    elif args.command == "short-term-trend-weight-optimizer":
        from .short_term_trend_weight_optimizer import run_short_term_trend_weight_optimizer
    ...
    elif args.command == "market-focus-diagnostics":
        from .market_focus_diagnostics import run_market_focus_diagnostics
    ...
    elif args.command == "reversal-edge-diagnostics":
        from .reversal_edge_diagnostics import run_reversal_edge_diagnostics
