...
type reports\experiments\moderate_fast_rejection_diagnostics_summary.txt
echo.
echo ============================================================
echo [FINAL RESULT] Performance Summary:
type reports\experiments\moderate_fast_performance_summary.txt
echo.
echo ============================================================
echo [FINAL RESULT] Opportunity Diagnostics Summary:
type reports\experiments\moderate_fast_opportunity_diagnostics_summary.txt
echo ============================================================
echo.
